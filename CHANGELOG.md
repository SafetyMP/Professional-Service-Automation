...
- Bump safe npm patch/minor dependencies (Next.js 16.3.1, Auth.js, Playwright, hook-form, lucide-react, TanStack Query, Zod, TypeScript types, tsx). Prisma stays on 7.8.x; `pg` remains pinned below 8.19. Vitest stays on 4.1.9 (npm arborist peer crash on 4.1.11).
